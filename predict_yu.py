...
# 从 Excel 文件中读取数据
data_df = pd.read_excel(r"./data/0840_0900_xlp.xlsx", sheet_name="Sheet1",engine='openpyxl')
data_df_ret = pd.read_excel(r"./data/0845_0905_xlp.xlsx", sheet_name="Sheet1",engine='openpyxl')
...
datay = data_df_ret[[target_column]].values
...
# 加载ONNX模型
sess = ort.InferenceSession("./model/lstm_2input_pdc_shift_xlp.onnx")
